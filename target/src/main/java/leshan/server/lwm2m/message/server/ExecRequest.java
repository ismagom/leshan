 ...
 */
public class ExecRequest implements ServerRequest {
    ...
    public ExecRequest(Integer objectId, Integer objectInstanceId, Integer resourceId) {
    ...
    public String toString() {
        ...
        builder.append("ExecRequest [id=").append(id).append(", objectId=").append(objectId)
